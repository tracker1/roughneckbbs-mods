...
bbs.mods.vanguard.assault.msg_sec.select_options.x1 = 2;
bbs.mods.vanguard.assault.msg_sec.select_options.y1 = 8;
bbs.mods.vanguard.assault.msg_sec.select_options.x2 = 24;
bbs.mods.vanguard.assault.msg_sec.select_options.y2 = 23;
...
bbs.mods.vanguard.assault.msg_sec.loadAnsi = function() {
	...
	console.clear();
	bbs.mods.vanguard.ansislow("rn/msg_sec");
	console.line_counter = 0;
}
...
bbs.mods.vanguard.assault.msg_sec.main = function() {
	try {
		//bbs.trace.write("vanguard.assault.msg_sec","begin main()");
		if (console.line_counter)
			console.pause();
		...
		while (bbs.online && !bbs.mods.vanguard.assault.msg_sec.options.mainExit) {
			//bbs.trace.clear(); //clear the trace stack... save memory/overflow
		...
		//bbs.trace.write("vanguard.assault.msg_sec","end main()");
	} catch(err) {
...
if (bbs.mods.vanguard.assault.msg_sec.debug) {
	if (bbs.mods.vanguard.assault.msg_sec.firstTrace) {
		//bbs.trace.close();
